package com.example.yassine.roomdemo.adapter;
...
import com.example.yassine.roomdemo.R;
import com.example.yassine.roomdemo.notedb.model.Note;
...
public class NotesAdapter extends RecyclerView.Adapter<NotesAdapter.BeanHolder> {
    ...
    public void onBindViewHolder(BeanHolder holder, int position) {
        ...
        holder.cd.setCardBackgroundColor(list.get(position).getColor());
    ...
    public class BeanHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public BeanHolder(View itemView) {
            ...
            cd = itemView.findViewById(R.id.imageView);
        }
